...
//	};
//
//	void Graph::TopologicalOrder() { // The n vertices of a network are listed in topoligical order
//		int top = -1;
//		for (int i = 0; i < n; i++) // create a linked stack of vertices with
//			if (count[i] == 0) { // no predecessors // 여기 다시 체크
//				count[i] = top;
//				top = i;
//			}
//		for (int i = 0; i < n; i++)
...
//			else { // 여기 다시 체크
//				int j = top;
//				top = count[top]; // unstack a vertex
//				cout << j << endl;
