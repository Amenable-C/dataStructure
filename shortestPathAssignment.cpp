...
int main(void) {
	...
	cout << "[Length-adgacency matrix]" << endl;
	...
	cout << "[Length-adgacency matrix For 0]" << endl;
	g->displayConnectionMatrix();
	cout << endl;

	cout << "[Shortest Path Table For 0]" << endl;
	start = 0;
	g->ShortestPath_display(start);
	cout << endl;
	...
	cout << endl;
	///////////////////////////
	cout << "1: custom setup,\n2: Default Setup1[sortest path(non-negative)],\n" << "3: Default Setup2[single source/all destinations(negative edge costs)](The Table given in the assignment)\n4: Default Setup3[allPairShortestPaths] =>";
	cin >> select;
	if (select == 1) {
